...
var ideaProjects = [
  ...
  ["Buy a kitten","Generate 600 ideas & Reach 500k views & Pay $5k","views>=500000 && ideasQtTotal>=600 && cashAmount >=5000","upgradeCreativity(2);ideaRangeMax(rangeIdea);cashAmount-=5000","They're the real OGs of YouTube <span class='boldRed'>[+2 Creativity & -$5k]</span>"],
  ["Buy a greenscreen","Reach 8 average video quality & Pay $10k","averageQl>=8 && cashAmount >=10000","upgradeCreativity(3);ideaRangeMax(rangeIdea);cashAmount-=10000","Your bedroom is now a creative cocoon <span class='boldRed'>[+3 Creativity & -$10k]</span>"],
  ["Figure out translating isn't plagiarism","Generate 1k ideas & Reach 1M subscribers","ideasQtTotal>=1000 && subscribers>=1000000","upgradeCreativity(3);ideaRangeMax(rangeIdea)","Ask Math Podcast about it <span class='boldRed'>[+3 Creativity]</span>"],
  ["Start streaming video games","Reach 5M subscribers & Pay $20k","subscribers>=5000000 && cashAmount>=20000","upgradeCreativity(3);ideaRangeMax(rangeIdea);cashAmount-=20000","About to reach the Ender Dragon... <span class='boldRed'>[+3 Creativity & -$20k]</span>"],
  ...
  ["Hire an experienced editor","Pay $8k & Reach 8.5 average video quality & 700k subscribers & 90M views","cashAmount>=8000&&averageQl>=8.5&&subscribers>=1000000&&views>=50000000","upgradeEditorSpeed(10);expenses+=25;cashAmount-=8000","One of Casey's old editors <span class='boldRed'>[AutoEditor Level 3 & -$8k & -$50/s]</span>"],
  ...
  ["Hire a badass editor","Pay $10k & Reach 9 average video quality & 1M subscribers & 500M views","cashAmount>=10000&&averageQl>=9&&subscribers>=1000000&&views>=500000000","upgradeEditorSpeed(20);expenses+=50;cashAmount-=10000","This is getting real <span class='boldRed'>[AutoEditor Level 4 & -$10k & -$100/s]</span>"],
  ...
  ["Get closer to the wifi","Upload 300 videos","videosUploaded>=500","upgradeUploadSpeed(16)","harder better faster stronger <span class='boldRed'>[+500kB/s Upload Speed]</span>"],
  ...
  ["Your building now has fibre-optic internet","Upload 6k videos","videosUploaded>=6000","upgradeUploadSpeed(54)","Can't get more efficient <span class='boldRed'>[+2000kB/s Upload Speed]</span>"],
  ...
  ["Hit the trending page","Reach 4M subscribers","subscribers>=4000000","views+=3000000","Is that a good thing though? <span class='boldRed'>[+3M Views]</span>"],
